...
from src.dependency_parser.biaff_parser import filter_tatweel, parse, parse_conll, parser_conll_to_conll_tuples
...
def main():
    ...
    string_lines = text_tuples_to_string(parsed_text_tuples, sentences=lines, is_conll=True)
